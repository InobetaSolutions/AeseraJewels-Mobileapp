...
class CatalogController extends GetxController {
  ...
  final cityController = TextEditingController();
  final postalCodeController = TextEditingController();
  final productAmountController = TextEditingController(); // ✅ New controller
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              /// ✅ Product Amount (now using buildInputField)
              buildInputField(
                "Product Amount",
      ...
      children: [
        ...
        Container(
          ...
          child: TextField(
            ...
            keyboardType: type,
            inputFormatters: inputFormatters,
            readOnly: readOnly, // ✅ Make Product Amount non-editable
            decoration: InputDecoration(
              hintText: hint,
              hintStyle: GoogleFonts.plusJakartaSans(
                fontSize: 14,
