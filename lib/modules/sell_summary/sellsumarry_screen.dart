...
//                       ),
//                       barrierDismissible:
//                           false, // user must tap OK or wait auto close
//                     );
...
//                   Expanded(
//                     child: Text(
//                       "${isRupees ? "Amount: ₹$value" : "Gold: $value gm"}",
              ...
              GestureDetector(
                onTap: () {
                  ...
                  if (walletBalance < payable) {
                    Get.dialog(
                      AlertDialog(
                        title: const Text("Insufficient Balance"),
                        content: Text(
                          "Your wallet balance is ₹${walletBalance.toStringAsFixed(2)} but payable is ₹${payable.toStringAsFixed(2)}",
                        ),
                        actions: [
                          TextButton(
                            onPressed: () {
                  ...
                  controller
                      .proceedToPay(
                        isRupees: isRupees,
                        value: hasSellData ? displayValue : value,
                      )
                      .then((_) {
                        ...
                        showDialog(
                          ...
                          builder: (_) {
                            ...
                            return AlertDialog(
                              ...
                              content: const Text(
                                "Sell payment created successfully.",
