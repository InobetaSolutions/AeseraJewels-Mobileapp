...
// //                 /// Mobile number field (only if not own)
// //                 if (!controller.isOwnNumber.value)
// //                   Column(
// //                     crossAxisAlignment: CrossAxisAlignment.start,
// //                     children: [
...
// //                           ],
// //                           onChanged: (v) =>
// //                               controller.enteredMobile.value = v,
// //                           style: GoogleFonts.plusJakartaSans(
// //                             fontSize: 16,
// //                             fontWeight: FontWeight.w400,
// //                             height: 24 / 16,
...
// //                       prefixIcon: Padding(
// //                         padding:
// //                             const EdgeInsets.only(left: 10, right: 8, top: 10),
// //                         child: Text(
// //                           controller.isRupees.value ? "₹" : "gm",
// //                           style: const TextStyle(
// //                             fontSize: 25,
...
// //                 const SizedBox(height: 80), // ✅ give space so last content not hidden
// //               ],
// //             ),
// //           ),
// //         ),
...
//     textController.addListener(() {
//       final txt = textController.text.trim();
//       controller.updateEnteredAmount(int.tryParse(txt) ?? 0);
//     });
...
//                 Text(controller.isRupees.value ? "Amount Paid" : "Weight (gm)"),
//                 const SizedBox(height: 6),
//                 _buildAmountField(textController),
//                 const SizedBox(height: 20),
...
//   Widget _buildAmountField(TextEditingController textController) {
//     return Container(
