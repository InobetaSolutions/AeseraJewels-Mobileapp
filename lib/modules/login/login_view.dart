...
//                 child: Text(
//                   'Mobile Number',
//                   style: GoogleFonts.lexend(color: Color(0xFF1A0F12),fontWeight: FontWeight.w500,fontSize: 16),
//                 ),
//               ),
...
//                   boxShadow: const [
//                     BoxShadow(
//                      color: Color(0x00000040), blurRadius: 4, offset: Offset(-0,3), spreadRadius: 0.02),
...
//                         :  Text(
//                             'Submit',
//                             style: GoogleFonts.lexend(color: Color(0xFFFAFAFA),
//                               fontWeight: FontWeight.w700,
...
//                   style: GoogleFonts.lexend(color: Color(0xFF2596BE),
//                     fontWeight: FontWeight.w400,
//                     fontSize: 14,
//                 ),
//               ),
